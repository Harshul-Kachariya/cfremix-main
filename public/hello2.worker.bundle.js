...
function HelloWorld2() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "p-5", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { className: "text-xl font-bold ", children: "Hello World 2 Component" }),
...
// app/common/hello2.worker.tsx
var renderComponent = () => {
  const html = import_server.default.renderToString(import_react2.default.createElement(HelloWorld2));
  return html;
};
